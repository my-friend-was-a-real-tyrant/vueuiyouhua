      ...
      <div class="row">
        <div class="col-md-8 m-auto">
         ...
         <!--   <TextField
              ...
              name="handle"
              placeholder="* 真实姓名"
              v-model="user.candidateUser.candidateUserName"
              :error="errors.candidateUserName"
              info="请填写真实姓名">
            </TextField>
            <TextField
              type="text"
              name="handle"
              placeholder="* 身份证号"
              v-model="user.candidateUser.candidateUserIdCard"
              :error="errors.candidateUserIdCard"
              info="请填写身份证号">
            </TextField>-->
            <TextField
              type="text"
        ...
        data() {
            return {
                msgInfo: {
                    ...
                    desiredIndustry: "",
                    desiredLocation: "",
                    emailIsVerification: 0,
                    emial: "",
                    expectedAnnualSalary: 0,
                    expectedMonthSalary: 0,
                    expectedNumberOfMonths: 0,
                    headPortrait: "",
                    incumbencyStatus: "",
                    isDefault: 0,
                    isSalariesConfidential: 0,
                    isShieldCompany: "",
                    jobTitle: "",
                    politic: "",
                    residence: "",
