  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 m-auto">
        ...
        <h1 class="display-4 text-center">编辑企业动态</h1>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                this.$axios.post('/api/admin/ourCompanyNews/update', this.msgInfo).then(res => {
            ...
            getData() {
                this.$axios.post('/api/admin/ourCompanyNewsItem/list').then(res => {
                    ...
                    let ourCompanyNewsId = this.$route.params.id;
                    console.log("ourCompanyNewsId", ourCompanyNewsId);
                    this.$axios.get('/api/admin/ourCompanyNews/get?id=' + ourCompanyNewsId).then(res => {
